(function initCustomCursor() {
  ...
  const hoverSel =
    "a, button, .btn, .navCta, .pf, .ct-link, .eu-card, .lang-card, .pj, .sk-tag, .num-block, .logo-wrap, .logo, .navToggle, .mm-cta, #btt, label, [role='button'], .act-card, .blog-card, .act-gallery-nav, .blog-modal-close, .act-modal-close";
  const textSel =
